  ...
  return (
    <main className="py-6 text-black px-4 max-w-4xl mx-auto min-h-screen bg-white">
      <div className="flex items-baseline justify-between gap-3 flex-wrap mb-8 border-b-4 border-black pb-4">
        <h1 className="text-4xl font-black italic uppercase tracking-tighter">League Leaders</h1>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-4 w-[180px] sm:w-[240px] shrink-0 border-l-2 border-gray-50 pl-4">
                ...
                <div className="text-center">
                  ...
                  <div className="text-xl font-black italic text-black tabular-nums">{p.gp}</div>
                </div>
                <div className="text-center">
                  <div className="text-[9px] font-black text-orange-600 uppercase tracking-tighter">PPG</div>
                  <div className="text-xl font-black italic text-orange-600 tabular-nums">
                    {p.ppg.toFixed(1)}
                  </div>
                </div>
              </div>
