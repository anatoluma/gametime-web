          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <div ref={languageRef} className="relative">
              <button
                ...
                className="h-9 px-2.5 rounded-md border border-zinc-700 bg-zinc-900 text-[10px] sm:text-xs font-black uppercase tracking-widest text-white inline-flex items-center gap-1"
        ...
        <div className="mt-1 grid grid-cols-4 items-center gap-1">
          {navLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className={`min-w-0 px-1 sm:px-2 py-2 text-center text-[10px] sm:text-xs font-black uppercase tracking-widest transition-colors whitespace-nowrap ${
